...
export const SERVER_INSTRUCTIONS = [
  ...
  "Start with get_analysis_context once status reports the analysis is ready: it returns the interpretation contract (how scores and evidence should be explained, boundaries, limitations), access scope, a compact preview of the top three hypotheses, and useful next questions. Use list_health_hypotheses for browsing, searching, sorting, or comparisons of hypotheses, and explain_health_hypothesis for one finding in depth.",
